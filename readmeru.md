...
Из-за особенностей оптимизации игрового движка Stormworks, текстуры камер перестают обновляться (кадры застывают) в следующих случаях:
* Если вы отходите слишком далеко от камеры или монитора.
* Если вы подходите к монитору вплотную (очень близко) или смотрите на него сквозь стены.
* Если вы сидите за рулем (в кресле пилота), а сам физический монитор находится вне зоны вашей видимости.

**Захват картинки в отдельное окно работает только тогда, когда игровой монитор находится в поле вашего зрения и рендерится игрой на любой дистанции.**

💡 **Решение:** Чтобы заставить движок игры принудительно обновлять текстуру удаленной камеры, установите маленький локальный монитор прямо в кабине техники (рядом со своим сиденьем) и выведите на него этот поток. Это заставит Stormworks постоянно обрабатывать картинку, и DLL-хук сможет стабильно транслировать её в окно.
