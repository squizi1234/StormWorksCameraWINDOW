...
## 🔍 Важное примечание о работе камер в игре (Culling)

Из-за особенностей оптимизации движка Stormworks, текстура камеры в отдельном окне обновляется только тогда, когда игровой монитор находится в поле зрения вашего персонажа (прямо перед вами).

Вот как конкретно работает эта механика:
* **Ограничение по дистанции:** Всё отлично работает вблизи и на расстоянии **до 700 метров**, если вы смотрите в сторону монитора. Если отойти дальше 700 метров, картинка застынет.
* **Сквозь стены и текстуры:** Всё работает отлично, даже если вы смотрите на монитор **сквозь стены или другие объекты** — главное, чтобы он физически находился в направлении вашего взгляда.
* **Внутри техники / За рулем:** Если вы сидите в кресле пилота, а монитор расположен у вас за спиной или сбоку (вне зоны прямого взгляда перед собой), картинка обновится только тогда, когда вы повернетесь к нему лицом. Экран должен быть направлен к вам, пусть даже он и скрыт за текстурами кабины.

💡 **Решение:** Если вам нужно постоянно видеть картинку с удаленной камеры (которая дальше 700 метров или находится сзади), просто поставьте маленький дублирующий монитор прямо перед своим сиденьем в кабине и выведите на него этот поток. Пока этот локальный экран находится перед вашим лицом, движок будет принудительно обрабатывать текстуру, и DLL-хук сможет стабильно её транслировать.
---
